...
class index(TemplateView):
    '''EcoMan index page
    '''
    template_name = 'EcoMan/index.html'
...
class qlca_welcome_screen(TemplateView):
    '''Welcome Screen QLCA Tool
    '''
    template_name = 'EcoMan/qlca_welcome_screen.html'
    def dispatch(self, request, *args, **kwargs):
        if not request.user.is_authenticated:
            return HttpResponseRedirect('/user/login')
        return super().dispatch(request, *args, **kwargs)

class qlca_analysis_welcome_screen(TemplateView):
    '''Welcome Screen QLCA Tool
    '''
    template_name = 'EcoMan/qlca_analysis_welcome_screen.html'
    def dispatch(self, request, *args, **kwargs):
        if not request.user.is_authenticated:
            return HttpResponseRedirect('/user/login')
        return super().dispatch(request, *args, **kwargs)    
