...
class Lca_Database_Subgroup(models.Model):
    identifier = models.CharField(max_length=2,unique=False, validators=[MinLengthValidator(3)])    
    ...
    group_model = models.ForeignKey("EcoMan.Lca_Database_Group", verbose_name="Group of the Subgroup", on_delete=models.CASCADE,  null=True,)   
