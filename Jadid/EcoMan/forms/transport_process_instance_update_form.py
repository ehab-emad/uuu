...
class TransportProcessInstanceUpdateForm(forms.ModelForm):
    '''
    ...
    additional_weight = forms.FloatField(label='Additional Weight [kg] (Containers, Rigs, Packaging, etc.)', min_value=0, required=False )
    def __init__(self, *args, **kwargs): 
        self.weight_unit = kwargs.pop('weight_unit', None)
        super(TransportProcessInstanceUpdateForm, self).__init__(*args, **kwargs)    
    ...
    class Meta:
        ...
        fields = ('id','name', 'notes', 'transport_distance', 'is_active',)
        widgets = {
          'notes': forms.Textarea(attrs={'rows':4, }),
        }
    field_order = ['name', 'process_name', 'process_name', 'part_weight', 'part_area', 'km',  'notes', 'id',] 
