...
class Friction_Joint(models.Model):
    ...
    mat_1_name = models.CharField(max_length=30, verbose_name= "Material 1",  editable=True, default= None)
    mat_2_name = models.CharField(max_length=30, verbose_name= "Material 2",  editable=True, default= None)

    lubrication = models.CharField(max_length=100, verbose_name= "Lubrication", editable=True, default= None)
